	...
	:BaseSystem{entityManager}
{
	...
	Events::EV_NEW_UI_ELEMENT WinScreenUIElement( canvas_Component, HTVector2{ 0.5f ,0.4f } ,kCanvasBasicSprite,"WinScreen" ,"Player1Win" ,"","","", nullptr );

	Events::EV_NEW_UI_ELEMENT RestartUIElement(canvas_Component, HTVector2{ 0.5f ,0.6f } ,kCanvasButton,"RestartButton" ,"UIBack" ,"Restart","UIBack_Hover","UIBack_Click", Restart );

	Events::EV_NEW_UI_ELEMENT ReturnToMainUIElement(canvas_Component, HTVector2{ 0.5f ,0.7f } ,kCanvasButton,"ReturnToMainButton" ,"UIBack" ,"Return To Main Menu","UIBack_Hover","UIBack_Click", QuitToMain );
